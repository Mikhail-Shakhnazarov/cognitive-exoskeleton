...
Port A executes. It takes specifications and produces artifacts â€” code, files, changes. It operates in the space of implementation, precision, and friction.

They don't share context. Port B doesn't know Port A's execution state unless operator provides it. Port A doesn't interpret ambiguity â€” it returns friction.
...
- [[operator_termination]] â€” who receives the friction
- [[observable_state]] â€” how friction becomes visible
- [[terse_architecture]] â€” how specs achieve precision
...
- [[port_separation]] â€” where loops get routed
- [[cognitive_exoskeleton]] â€” the containing design philosophy
- [[observable_state]] â€” what operator needs to decide
...
Terse is high structure-per-token, not brevity. Many tokens do double duty â€” carrying semantic content while encoding relation (contrast, causality, modification, reference).
...
Terse is diagnostic. If a concept can't be stated tersely without spawning new nouns, caveats, or connective tissue not anchored to decisions â€” the state is liquid. Noun proliferation signals instability. Caveat chains signal uncertainty. Terse forces clarity.
...
- [[cognitive_load]] â€” terse reduces extraneous load
- [[extended_cognition]] â€” terse artifacts as cognitive scaffolds
- [[observable_state]] â€” terse enables inspection
